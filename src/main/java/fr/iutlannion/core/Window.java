...
import fr.iutlannion.auth.pageEnregistrementVehicule;
...
public class Window extends Stage {
	...
	private static pageEnregistrementVehicule enregistrementVehicule = new pageEnregistrementVehicule();
	...
	static {
		...
		scenes.put("pageEnregistrementVehicule", new Scene(enregistrementVehicule.creerContenu()));
	}
